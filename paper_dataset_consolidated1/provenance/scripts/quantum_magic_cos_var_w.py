...
# Linear / exp / trig. This file scans w for a cosine coupling.
args = {
    "g0": 1,
    "eta": 1,
    "w": 2 * np.pi / 50,
...
np.save(os.path.join(save_dir, "w_list.npy"), w_list)
...
# salvar var / var_aberto como matrizes: (len(w_list), len(t))
